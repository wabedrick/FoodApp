        ...
        <table class="table datatable table-striped">
          ...
          <tbody>
            ...
            <?php while ($borrower_group = $result->fetch_assoc()) { ?>
              ...
              <tr>
                <td scope="row"><a href="view-borrower-group.php?id=<?php echo $borrower_group['id']; ?>"
                 title="View" class="text-danger"><i class="bi bi-eye-fill"></i></a></td>
                <td><?php echo $borrower_group['id']; ?></td>
                <td> <?php echo $borrower_group['name']; ?></td>
                <td><?php echo $borrower_group['location']; ?></td>
                <td><?php echo $borrower_group['district']; ?></td>
